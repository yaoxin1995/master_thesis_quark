...
use crate::qlib::kernel::fs::secretfs::proc::ProcNode;

#[enum_dispatch(SecretDirDataNode)]
pub trait SecretDirDataNodeTrait: Send + Sync {
...
#[enum_dispatch]
#[derive(Clone)]
pub enum SecretDirDataNode {
    ProcNode(ProcNode),
}

impl SecretDirDataNode {
...
#[derive(Clone)]
pub struct SecDirNode {
    pub dir: Dir,
    pub data: SecretDirDataNode,
}

impl InodeOperations for SecDirNode {
    fn as_any(&self) -> &Any {
        return self;
    }
