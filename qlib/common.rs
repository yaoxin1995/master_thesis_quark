...
pub const RFLAGS_RESTORABLE: u64 = RFLAGS_AC
    | RFLAGS_OF
    | RFLAGS_DF
    | RFLAGS_STEP
    | RFLAGS_SF
...
impl TcpipErr {
    ...
    pub const ERR_UNKNOWN_PROTOCOL: Self = Self {
        msg: "unknown protocol",
        ignoreStats: false,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_UNKNOWN_NICID: Self = Self {
        msg: "unknown nic id",
        ignoreStats: false,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_UNKNOWN_DEVICE: Self = Self {
        msg: "unknown device",
        ignoreStats: false,
        sysErr: SysErr::ENODEV,
    };
    pub const ERR_UNKNOWN_PROTOCOL_OPTION: Self = Self {
        msg: "unknown option for protocol",
        ignoreStats: false,
        sysErr: SysErr::ENOPROTOOPT,
    };
    pub const ERR_DUPLICATE_NICID: Self = Self {
        msg: "duplicate nic id",
        ignoreStats: false,
        sysErr: SysErr::EEXIST,
    };
    pub const ERR_DUPLICATE_ADDRESS: Self = Self {
        msg: "duplicate address",
        ignoreStats: false,
        sysErr: SysErr::EEXIST,
    };
    pub const ERR_NO_ROUTE: Self = Self {
        msg: "no route",
        ignoreStats: false,
        sysErr: SysErr::EHOSTUNREACH,
    };
    pub const ERR_BAD_LINK_ENDPOINT: Self = Self {
        msg: "bad link layer endpoint",
        ignoreStats: false,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_ALREADY_BOUND: Self = Self {
        msg: "endpoint already bound",
        ignoreStats: true,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_INVALID_ENDPOINT_STATE: Self = Self {
        msg: "endpoint is in invalid state",
        ignoreStats: false,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_ALREADY_CONNECTING: Self = Self {
        msg: "endpoint is already connecting",
        ignoreStats: true,
        sysErr: SysErr::EALREADY,
    };
    pub const ERR_ALREADY_CONNECTED: Self = Self {
        msg: "endpoint is already connected",
        ignoreStats: true,
        sysErr: SysErr::EISCONN,
    };
    pub const ERR_NO_PORT_AVAILABLE: Self = Self {
        msg: "no ports are available",
        ignoreStats: false,
        sysErr: SysErr::EAGAIN,
    };
    pub const ERR_PORT_IN_USE: Self = Self {
        msg: "port is in use",
        ignoreStats: false,
        sysErr: SysErr::EADDRINUSE,
    };
    pub const ERR_BAD_LOCAL_ADDRESS: Self = Self {
        msg: "bad local address",
        ignoreStats: false,
        sysErr: SysErr::EADDRNOTAVAIL,
    };
    pub const ERR_CLOSED_FOR_SEND: Self = Self {
        msg: "endpoint is closed for send",
        ignoreStats: false,
        sysErr: SysErr::EPIPE,
    };
    pub const ERR_CLOSED_FOR_RECEIVE: Self = Self {
        msg: "endpoint is closed for receive",
        ignoreStats: false,
        sysErr: SysErr::NONE,
    };
    pub const ERR_WOULD_BLOCK: Self = Self {
        msg: "operation would block",
        ignoreStats: true,
        sysErr: SysErr::EWOULDBLOCK,
    };
    pub const ERR_CONNECTION_REFUSED: Self = Self {
        msg: "connection was refused",
        ignoreStats: false,
        sysErr: SysErr::ECONNREFUSED,
    };
    pub const ERR_TIMEOUT: Self = Self {
        msg: "operation timed out",
        ignoreStats: false,
        sysErr: SysErr::ETIMEDOUT,
    };
    pub const ERR_ABORTED: Self = Self {
        msg: "operation aborted",
        ignoreStats: false,
        sysErr: SysErr::EPIPE,
    };
    pub const ERR_CONNECT_STARTED: Self = Self {
        msg: "connection attempt started",
        ignoreStats: true,
        sysErr: SysErr::EINPROGRESS,
    };
    pub const ERR_DESTINATION_REQUIRED: Self = Self {
        msg: "destination address is required",
        ignoreStats: false,
        sysErr: SysErr::EDESTADDRREQ,
    };
    pub const ERR_NOT_SUPPORTED: Self = Self {
        msg: "operation not supported",
        ignoreStats: false,
        sysErr: SysErr::EOPNOTSUPP,
    };
    pub const ERR_QUEUE_SIZE_NOT_SUPPORTED: Self = Self {
        msg: "queue size querying not supported",
        ignoreStats: false,
        sysErr: SysErr::ENOTTY,
    };
    pub const ERR_NOT_CONNECTED: Self = Self {
        msg: "endpoint not connected",
        ignoreStats: false,
        sysErr: SysErr::ENOTCONN,
    };
    pub const ERR_CONNECTION_RESET: Self = Self {
        msg: "connection reset by peer",
        ignoreStats: false,
        sysErr: SysErr::ECONNRESET,
    };
    pub const ERR_CONNECTION_ABORTED: Self = Self {
        msg: "connection aborted",
        ignoreStats: false,
        sysErr: SysErr::ECONNABORTED,
    };
    pub const ERR_NO_SUCH_FILE: Self = Self {
        msg: "no such file",
        ignoreStats: false,
        sysErr: SysErr::ENOENT,
    };
    pub const ERR_INVALID_OPTION_VALUE: Self = Self {
        msg: "invalid option value specified",
        ignoreStats: false,
        sysErr: SysErr::EINVAL,
    };
    pub const ERR_NO_LINK_ADDRESS: Self = Self {
        msg: "no remote link address",
        ignoreStats: false,
        sysErr: SysErr::EHOSTDOWN,
    };
    pub const ERR_BAD_ADDRESS: Self = Self {
        msg: "bad address",
        ignoreStats: false,
        sysErr: SysErr::EFAULT,
    };
    pub const ERR_NETWORK_UNREACHABLE: Self = Self {
        msg: "network is unreachable",
        ignoreStats: false,
        sysErr: SysErr::ENETUNREACH,
    };
    pub const ERR_MESSAGE_TOO_LONG: Self = Self {
        msg: "message too long",
        ignoreStats: false,
        sysErr: SysErr::EMSGSIZE,
    };
    pub const ERR_NO_BUFFER_SPACE: Self = Self {
        msg: "no buffer space available",
        ignoreStats: false,
        sysErr: SysErr::ENOBUFS,
    };
    pub const ERR_BROADCAST_DISABLED: Self = Self {
        msg: "broadcast socket option disabled",
        ignoreStats: false,
        sysErr: SysErr::EACCES,
    };
    pub const ERR_NOT_PERMITTED: Self = Self {
